...
Menu::Menu()
{
	...
	buttons["ranking"] = new Button("ranking_button", "Ranking", myType::Vector2(0, 200), myType::Color(0, 0, 0, 255), myType::Color(255, 0, 0, 255), "gameplay", true);
	buttons["toggleSound"] = new Button("sound_button", "Sound ON", myType::Vector2(0, 300), myType::Color(0, 0, 0, 255), myType::Color(255, 0, 0, 255), "gameplay", true);
	buttons["exit"] = new Button("exit_button", "Exit", myType::Vector2(0, 400), myType::Color(0, 0, 0, 255), myType::Color(255, 0, 0, 255), "gameplay", true);
}
